// SpecImage
// Defines a Spectral Image, which contains hundreds of separate images taken of 
//  the same location at varying wavelengths over a large range. This object is 
//  designed to work with a dataset provided by the EO_1 Hyperion satellite. The 
//  purpose of this object is to make it easier to manage and fetch data in the 
//  provided image, to ease filtering of the data.
